  ...
  return (
    <div className='px-4 w-[20vw] py-5 border-r-[1px] min-h-full max-h-screen border-gray-300'>
      ...
      <div className='py-4'>
        ...
        <img className='w-4 h-4 rounded-full object-center' src="https://avatars.githubusercontent.com/u/94969888?v=4" alt="" />
        <span className='flex items-center text-sm font-bold'>devn5900 
